...
public class Locators {
    ...
    public static final By MENU_BUTTON = By.cssSelector("nav ul li a");
    public static final By X_BUTTON = By.className("close");
    public static final By MENU = By.id("menu");
    public static final By MENU_ITEMS = By.cssSelector("#menu > div > ul > li");
    public static final By MAIN_MENU_ITEMS = By.cssSelector("#main > div > section > article");
    ...
    public static final By ERROR_MSG = By.xpath("//*[contains(text(),'This XML file does not appear to have any style')]");
}
